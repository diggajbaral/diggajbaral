...
🤫 · 2026 - Present  
- Building a modern **personal identity and profile platform** that allows users to create, manage and share their digital identity through a unique username-based URL.
- Developing the platform using **Django, Python, HTML, CSS and JavaScript**, with database-backed profiles, image uploads and customizable social links.
- Implementing **secure authentication and profile management**, with Django ModelForms for structured validation and reliable data handling.
- Designing **SEO-friendly public profile pages** with dynamic usernames, metadata and shareable profile URLs.
- Focusing on **simplicity, performance, responsive design and scalable architecture**, with plans to expand 🤫 into a broader personal identity platform.
